            ...
            if (url.indexOf('TB_iframe') != -1) {// either iframe or ajax window		
                ...
                if ($("#TB_window").css("display") != "block") {
                    if (params['modal'] != "true") {//ajax no modal
                        $("#TB_window").append("<div id='TB_title'><div id='TB_ajaxWindowTitle'>" + caption + "</div><div id='TB_closeAjaxWindow'><a href='#' id='TB_closeWindowButton'><i class='fa fa-close'></i></a></div></div><div id='TB_ajaxContent' style='width:" + ajaxContentW + "px;height:" + ajaxContentH + "px'></div>");
                    } else {//ajax modal
                        $("#TB_overlay").unbind();
...
function tb_position() {
    ...
    if ((TB_HEIGHT + '').indexOf('%') > 0)
    {
        ...
        $("#TB_window").css({ marginTop: '0px', height: TB_HEIGHT });
    }
    else
